...
public class Versao_02 {
    ...
    static void escolha_do_Menu1(int escolhaMenu1) {
    ...
    static void escolha_do_Menu2(int escolhaMenu1) {
    ...
    static void escolha_do_Menu3(int escolhaMenu1) {
    ...
    static void escolha_do_Menu4(int escolhaMenu1) {
