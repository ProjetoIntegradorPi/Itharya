...
public class Versao_08 {
    ...
    static void escolha_do_Menu1(int escolhaMenu1) { // Função que inicia o jogo
        ...
        System.out.println("------------------------------------------------------------------------------------");
        System.err.print("Digite o nome do Personagem: "); //
        ...
        if (classe.equals("Cientista") || classe.equals("cientista") || classe.equals("CIENTISTA")){
    ...
    static void escolha_do_Menu2(int escolhaMenu1) { //Função que apresenta a história do jogo.
        ...
        System.out.println("" // história do jogo
                ...
                + "\nAssim, um experimento começou, a Terra 2.0. Líderes mundiais se uniram para cria uma estação espacial na Lua,"
