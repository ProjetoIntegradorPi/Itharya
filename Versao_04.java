...
"_______________|______________|__|__|_____|________________");
    ...
    static int[] embaralhar_Andar1 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 1 e embaralha esses números
    ...
    static int[] embaralhar_Andar2 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 2 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar3 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 3 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar4 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 4 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar5 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 5 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar6 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 6 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar7 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 7 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar8 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 8 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar9 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 9 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static int[] embaralhar_Andar10 () { // Essa função cria uma lista de números, com a quantidade de perguntas que eu tenho no andar 10 e embaralha esses números
        Random gerador = new Random();
        int a, b, temp;
    ...
    static void quizEContinuidadeDoJogo_Andar1() { //Essa função irá chamar a pergunta aleatória do primeiro andar
        ...
        String escolha;
        int[] sequencia = embaralhar_Andar1(); //Cria a variavel sequencia com os valores embaralhados da função embaralhar_Andar1
